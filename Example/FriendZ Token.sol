/* FriendZ SmartContract
- Có hàm Burn token.
- Có khả năng khóa hàm transfer(), chỉ có vài address có thể thực hiện việc chuyển token
- Có 1 smart FriendZICO riêng.
- Có ngày Release và ngày Purchase
*/ 
